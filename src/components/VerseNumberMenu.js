...
// const VerseJoinUnjoinMenuFragment = ({ verseNumberString }) => {
//     const editor = useSlate()
...
// VerseMenuButton.muiName = StyledMenuItem.muiName
...
// class JoinWithPreviousVerseButton extends React.Component {
//     render() {
//         return (
//             <VerseMenuButton
//                 icon={LinkIcon}
//                 text={"Merge with previous verse"}
//                 handleClick={event => {
//                     MyTransforms.joinWithPreviousVerse(this.props.editor)
//                 }}
//             />
//         )
//     }
...
// JoinWithPreviousVerseButton.muiName = VerseMenuButton.muiName
...
// UnjoinVerseRangeButton.muiName = VerseMenuButton.muiName
