...
reflected in the noted section of this demo page. This demo utilizes these properties in a HOC editor; however, the application itself 
can supply the values of these properties without wrapping another editor. Note that the chapter and verse input fields are not kept 
up to date with the current value of the startingVerse property.
```js
const usfmString = `
\\id GEN
\\c 1
